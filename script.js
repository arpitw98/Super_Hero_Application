...
// 094c287573e9ce7c38dd2049d37e957d

// Private Key

// 0d5a7358ba7303145e38e281ae4f1f9cb823ff45

// hash id

// 376cd999606621ece378a5d575a5551b

// hash -> 10d5a7358ba7303145e38e281ae4f1f9cb823ff45094c287573e9ce7c38dd2049d37e957d

const publicKey = "094c287573e9ce7c38dd2049d37e957d";
const url =
  "https://gateway.marvel.com/v1/public/characters?ts=1&apikey=094c287573e9ce7c38dd2049d37e957d&hash=376cd999606621ece378a5d575a5551b ";
    ...
    if (unfavButton) {
      for (let button of unfavButton) {
        button.addEventListener(
          "click",
          (e) => {
            let index = favouriteSuperHeroList.indexOf(
              e.target.parentElement.firstElementChild.innerText
            );

            favouriteSuperHeroList.splice(index, 1);
            window.localStorage.setItem(
              "favData",
              JSON.stringify(favouriteSuperHeroList)
            );
...
// home page content 
  ...
  if (savedLocalFavData !== null && savedLocalFavData.length > 0) {
    favouriteSuperHeroList = savedLocalFavData;
    data.forEach((element) => {
...
function handleFav(e, item) {
  ...
  if (index === -1) {
    favouriteSuperHeroList.push(e.target.previousElementSibling.innerText);
    window.localStorage.setItem("favData", JSON.stringify(favouriteSuperHeroList));
